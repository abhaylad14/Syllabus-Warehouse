...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2021 at 01:00 PM
...
INSERT INTO `tbl_bos` (`Id`, `MeetingName`, `MeetingVenue`, `MeetingDate`, `MeetingAgenda`, `Minutes`, `SyllabusZip`, `TesZip`, `Remark`, `Status`) VALUES
(1, 'new meeting1', 'UTU', '2021-03-27', '../syllabusfiles/bos/agenda/1616199939.docx', '', '../syllabusfiles/bos/syllabus/1616200676.rar', '../syllabusfiles/bos/tes/1616201502.zip', 'r1', '0'),
(2, 'BOS7', 'Maliba Pharmacy Conference hall', '2021-03-21', '../syllabusfiles/bos/agenda/1616214869.docx', '../syllabusfiles/bos/minutes/1616683748.pdf', '../syllabusfiles/bos/syllabus/1616214869.zip', '../syllabusfiles/bos/syllabus/1616214869.zip', 'r2', '0'),
(3, 'BOSS', 'UTU', '2021-03-26', '../syllabusfiles/bos/agenda/1616680421.pdf', '../syllabusfiles/bos/minutes/1616680421.pdf', '../syllabusfiles/bos/syllabus/1616680421.zip', '../syllabusfiles/bos/syllabus/1616680421.zip', 'r3', '0'),
(4, 'BOS99', 'UTU', '2021-03-26', '../syllabusfiles/bos/agenda/1616681801.pdf', '../syllabusfiles/bos/minutes/1616681801.pdf', '../syllabusfiles/bos/syllabus/1616681801.zip', '../syllabusfiles/bos/tes/1616681801.zip', 'hello 123', '0'),
(5, 'new meeting demo', 'UTU', '2021-04-11', '../syllabusfiles/bos/agenda/1617540710.pdf', '../syllabusfiles/bos/minutes/1617540710.pdf', '../syllabusfiles/bos/syllabus/1617540710.zip', '../syllabusfiles/bos/tes/1617540710.zip', 'hello', '0');
...
--
-- Dumping data for table `tbl_syllabus_config_assign`
--

INSERT INTO `tbl_syllabus_config_assign` (`Id`, `Subject`, `UserId`, `DocText`, `Isleader`, `Comments`, `AssignDate`, `VerifyDate`, `Status`) VALUES
(3, 'php', 6, NULL, '1', '', '2021-04-04', '2021-04-04', '1'),
(4, 'php', 11, NULL, '0', '', '2021-04-04', '2021-04-04', '1'),
(5, 'php', 10, NULL, '0', '', '2021-04-04', '2021-04-04', '1'),
(6, 'Cloud Computing', 8, '../syllabusfiles/1617518561.docx', '0', '', '2021-04-04', NULL, '0'),
(7, 'Cloud Computing', 6, '../syllabusfiles/1617518561.docx', '1', '', '2021-04-04', NULL, '0');
...
--
ALTER TABLE `tbl_announcements`
  ADD CONSTRAINT `tbl_announcements_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `tbl_users` (`Id`);

--
-- Constraints for table `tbl_syllabus_config_assign`
--
ALTER TABLE `tbl_syllabus_config_assign`
  ADD CONSTRAINT `tbl_syllabus_config_assign_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `tbl_users` (`Id`);

--
-- Constraints for table `tbl_syllabus_config_transaction`
--
ALTER TABLE `tbl_syllabus_config_transaction`
  ADD CONSTRAINT `tbl_syllabus_config_transaction_ibfk_1` FOREIGN KEY (`SubjectId`) REFERENCES `tbl_subjects` (`Id`),
  ADD CONSTRAINT `tbl_syllabus_config_transaction_ibfk_2` FOREIGN KEY (`ConfigId`) REFERENCES `tbl_syllabus_config_master` (`Id`);
COMMIT;
